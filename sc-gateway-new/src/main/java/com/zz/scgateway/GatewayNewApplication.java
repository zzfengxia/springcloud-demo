...
public class GatewayNewApplication {
     ...
     * 参数为{@link RouteLocator}接口的实现类集合。比如{@link com.zz.scgateway.GatewayNewApplication#myRoutes}定义的实现
     ...
     * 动态路由实现参考{@link com.zz.scgateway.service.DynamicGatewayService}
     *
     * @param builder
     * @return
     */
