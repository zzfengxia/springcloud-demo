...
import com.zz.scgatewaynew.routedefine.CustomApiDefinition;
import com.zz.scgatewaynew.routedefine.SentinelDefinition;
...
public class SentinelConfigForGateway {
    ...
    public void doInit() {
        ...
        DataSourcePropertiesConfiguration ds = sentinelProperties.getDatasource().get("dsnacos");
        if(ds == null) {
            return;
        }
        NacosDataSourceProperties nacosDataSourceProperties = ds.getNacos();
        if(nacosDataSourceProperties == null) {
            return;
        }
        log.info("sentinel dynamic ds config with nacos");
        /**
         * 动态限流规则配置参考
         * <pre>
         * [
