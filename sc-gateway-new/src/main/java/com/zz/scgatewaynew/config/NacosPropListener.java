...
import com.zz.scgatewaynew.routedefine.RouteRuleProp;
...
@Component
@Slf4j
public class NacosPropListener implements ApplicationListener<RefreshEvent>, ApplicationEventPublisherAware {
    @Autowired
    ...
    public void onApplicationEvent(RefreshEvent event) {
        if(!(event.getEvent() instanceof RouteRuleProp) || predicateRulesList == null) {
            return;
        }
