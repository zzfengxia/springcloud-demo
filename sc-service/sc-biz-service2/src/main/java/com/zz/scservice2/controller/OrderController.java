...
public class OrderController /*implements OrderClient*/ {
    ...
    @GetMapping("/getOrder")
    public String getOrderInfo(@RequestBody OrderInfo params1, @RequestHeader Map<String, String> headers) {
    ...
    public OrderInfo createOrder(@RequestBody OrderInfo params, @RequestHeader Map<String, String> headers) {
        log.info("request headers:" + JSON.toJSON(headers));
